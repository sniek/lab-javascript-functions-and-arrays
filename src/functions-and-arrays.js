...
function averageWordLength(arr) {
  ...
  const bigString = arr.reduce((a, b) => a + b);
  return bigString.length / arr.length;
}
...
function howManyTimes(arr, obj) {
  if (arr == '') return 0;
  const newArray = arr.filter(word => word == obj);
